...
Последний пункт я сразу откинул, так как Notion без платной подписки крайне урезанный. Obsidian же мне понравился и я его использую до сих пор, но я его использую как раз таки с интеграцией в Hugo и мою конфигурацию Neovim(Об этом в другой раз). Я не стал использовать исключительно Obsidian, потому что его каждый раз надо устанавливать.
...
После установки мы может проверить версию данного инструмента, чтобы убедиться установился ли он.
